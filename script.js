$(document).ready(function () {
  ...
  const toggle = document.getElementById("toggleThemeSwitch");
  ...
  // Sortable wishlist with interaction message
  $("#availablePlaces, #wishlist").sortable({
    connectWith: ".sortable-list",
    placeholder: "ui-state-highlight",
    update: function () {
      $("#sortMessage").stop(true, true).fadeIn().delay(2500).fadeOut();
    }
  }).disableSelection();

  $("#closeSortMsg").on("click", function () {
    $("#sortMessage").fadeOut();
  });
